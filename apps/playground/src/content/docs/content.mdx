...
<CopyPrompt>
  <p>You are working in a Sentry documentation project.</p>
  <ol>
    <li>Read the repository instructions before editing.</li>
    <li>Make the smallest coherent change.</li>
    <li>Run the project checks and report the results.</li>
  </ol>
</CopyPrompt>
